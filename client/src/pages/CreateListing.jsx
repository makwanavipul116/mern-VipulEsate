...
const CreateListing = () => {
    ...
    return (
        <main className='p-3 max-w-4xl mx-auto'>
            <h1 className='text-3xl font-semibold text-slate-700 text-center mt-1  my-4'>Create List</h1>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className="flex flex-col flex-1 gap-3">
                    ...
                    <button disabled={loading || uploading} className='p-3 bg-slate-800 text-white rounded-lg hover:opacity-95 disabled:opacity-80'>{loading || uploading ? "Loading..." : "Create Listing"}</button>

                    {listingSuccess && <p className='text-green-700'>"create Listing successFully"</p>}
